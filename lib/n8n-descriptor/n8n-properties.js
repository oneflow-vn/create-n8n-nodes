...
function modifyNodeProperties (n8nNodeProperties) {
  ...
  // const originalFromRefResolverFindRef = originalFromRefResolver.findRef;

  // originalFromRefResolver.findRef = function (ref) {
  //   console.log('-----------', {ref});
  //   return originalFromRefResolverFindRef.call(this, ref);
  // };
  ...
  n8nNodeProperties.resolveBodySchema = function (body) {
    ...
    console.log('resolveBodySchema', { requestBodySchema });
  ...
  n8nNodeProperties.fromRequestBody = function (body) {
    ...
    // console.log('fromRequestBody', {schema, contentKey});
